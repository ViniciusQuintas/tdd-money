...
describe('Money', () => {
  it('should correctly handle money multiplication', () => {
  ...
  it('should handle simple adition', () => {
  ...
  it('should handle identify rate', () => {
  ...
  it('should handle plus operation in a sum ', () => {
    const fiveBucks: Expression = Money.dollar(5)
    const tenEuros: Expression = Money.euro(10)
    const bank = new Bank()
    bank.addRate('EUR', 'USD', 2)
  ...
  it('should handle times operation in a sum ', () => {
    const fiveBucks: Expression = Money.dollar(5)
    const tenEuros: Expression = Money.euro(10)
    const bank = new Bank()
    bank.addRate('EUR', 'USD', 2)
